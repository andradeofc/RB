    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('today_earning', models.FloatField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('daily_limit', models.FloatField(default=60)),
                ('minimum_withdrawl', models.FloatField(default=500)),
                ('maximum_earning_per_day', models.FloatField(default=50)),
                ('minimum_per_click', models.FloatField(default=0.1)),
                ('maximum_per_click', models.FloatField(default=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('Current', 'Current'), ('Saving', 'Saving')], default='Current', max_length=10)),
                ('bank_number', models.CharField(default='', max_length=50)),
